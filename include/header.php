...
<div class="menu-main-menu-container">
	<ul id="menu-main-menu" class="nav navbar-nav">
		...
		<li itemscope="itemscope"  id="menu-item-84" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-84"><a title="Career Info" href="career_info.php">My Skills</a></li>
